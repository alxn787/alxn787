      ...
      <div className="max-w-2xl mx-auto p-4 md:p-8">
        ...
        <main>
            ...
            <div className="text-neutral-300 space-y-4">
              <p className='text-md'>
                Hello! I&rsquo;m Alen, a 21 y/o CS student at IIIT K who loves to build cool stuff. <br></br>I&rsquo;m a dev, trader who is particularly interested about how tech works in finance.<br></br> I play the  piano/guitar and drive when im bored.
              </p>
            </div>
